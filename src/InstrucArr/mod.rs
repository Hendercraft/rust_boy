...
pub fn createOperations() -> Vec<Instruct>{
    ...
    //Add n to A
    out[0x87] = Instruct::build_instruct(0x87, String::from("ADD A A"), String::from("Add A to A"), 0, 4, Op::no(InstrucFn::add_a));
    out[0x80] = Instruct::build_instruct(0x80, String::from("ADD A B"), String::from("Add B to A"), 0, 4, Op::no(InstrucFn::add_b));
    out[0x81] = Instruct::build_instruct(0x81, String::from("ADD A C"), String::from("Add C to A"), 0, 4, Op::no(InstrucFn::add_c));
    out[0x82] = Instruct::build_instruct(0x82, String::from("ADD A D "), String::from("Add D to A"), 0, 4, Op::no(InstrucFn::add_d));
    out[0x83] = Instruct::build_instruct(0x83, String::from("ADD A E"), String::from("Add E to A"), 0, 4, Op::no(InstrucFn::add_e));
    out[0x84] = Instruct::build_instruct(0x84, String::from("ADD A H"), String::from("Add H to A"), 0, 4, Op::no(InstrucFn::add_h));
    out[0x85] = Instruct::build_instruct(0x85, String::from("ADD A L"), String::from("Add L to A"), 0, 4, Op::no(InstrucFn::add_l));
    out[0x86] = Instruct::build_instruct(0x86, String::from("ADD A (HL)"), String::from("Add ram[HL] to A"), 0, 8, Op::ram(InstrucFn::add_hlp));
    out[0xC6] = Instruct::build_instruct(0xC6, String::from("ADD A n"), String::from("Add n to A"), 1, 8, Op::u8(InstrucFn::add_u8));
    //Add n + carry flag to A
    out[0x8F] = Instruct::build_instruct(0x8F, String::from("ADC A A"), String::from("Add A + Cflag to A"), 0, 4, Op::no(InstrucFn::adc_a));
    out[0x88] = Instruct::build_instruct(0x88, String::from("ADC A B"), String::from("Add B + Cflag to A"), 0, 4, Op::no(InstrucFn::adc_b));
    out[0x89] = Instruct::build_instruct(0x89, String::from("ADC A C"), String::from("Add C + Cflag to A"), 0, 4, Op::no(InstrucFn::adc_c));
    out[0x8A] = Instruct::build_instruct(0x8A, String::from("ADC A D"), String::from("Add D + Cflag to A"), 0, 4, Op::no(InstrucFn::adc_d));
    out[0x8B] = Instruct::build_instruct(0x8B, String::from("ADC A E"), String::from("Add E + Cflag to A"), 0, 4, Op::no(InstrucFn::adc_e));
    out[0x8C] = Instruct::build_instruct(0x8C, String::from("ADC A H"), String::from("Add H + Cflag to A"), 0, 4, Op::no(InstrucFn::adc_h));
    out[0x8D] = Instruct::build_instruct(0x8D, String::from("ADC A L"), String::from("Add L + Cflag to A"), 0, 4, Op::no(InstrucFn::adc_l));
    out[0x8E] = Instruct::build_instruct(0x8E, String::from("ADC A (HL)"), String::from("Add ram[HL] + Cflag to A"), 0, 8, Op::ram(InstrucFn::adc_hlp));
    out[0xCE] = Instruct::build_instruct(0xCE, String::from("ADC A n"), String::from("Add n + Cflag to A"), 1, 8, Op::u8(InstrucFn::adc_u8));
    //Sub from A
    out[0x97] = Instruct::build_instruct(0x97, String::from("SUB A"), String::from("Sub A from A"), 0, 4, Op::no(InstrucFn::sub_a));
    out[0x90] = Instruct::build_instruct(0x90, String::from("SUB B"), String::from("Sub B from A"), 0, 4, Op::no(InstrucFn::sub_b));
    out[0x91] = Instruct::build_instruct(0x91, String::from("SUB C"), String::from("Sub C from A"), 0, 4, Op::no(InstrucFn::sub_c));
    out[0x92] = Instruct::build_instruct(0x92, String::from("SUB D"), String::from("Sub D from A"), 0, 4, Op::no(InstrucFn::sub_d));
    out[0x93] = Instruct::build_instruct(0x93, String::from("SUB E"), String::from("Sub E from A"), 0, 4, Op::no(InstrucFn::sub_e));
    out[0x94] = Instruct::build_instruct(0x94, String::from("SUB H"), String::from("Sub H from A"), 0, 4, Op::no(InstrucFn::sub_h));
    out[0x95] = Instruct::build_instruct(0x95, String::from("SUB L"), String::from("Sub L from A"), 0, 4, Op::no(InstrucFn::sub_l));
    ...
    //ADD 16 bits
    out[0x09] = Instruct::build_instruct(0x09, String::from("ADD HL BC"), String::from("Add BC to HL"), 0, 8, Op::no(InstrucFn::add_hl_bc));
    out[0x19] = Instruct::build_instruct(0x19, String::from("ADD HL DE "), String::from("Add DE to HL"), 0, 8, Op::no(InstrucFn::add_hl_de));
    out[0x29] = Instruct::build_instruct(0x29, String::from("ADD HL HL"), String::from("Add HL to HL"), 0, 8, Op::no(InstrucFn::add_hl_hl));
    out[0x39] = Instruct::build_instruct(0x39, String::from("ADD HL SP"), String::from("Add SP to HL"), 0, 8, Op::no(InstrucFn::add_hl_sp));
    //Add Sp
    out[0xE8] = Instruct::build_instruct(0xE8, String::from("ADD SP n /!\\"), String::from("Add n to SP"), 1, 16, Op::no(InstrucFn::nop)); //TODO use add_16?
    //INC 16 bits
    ...
    //out[0x31] = Instruct::build_instruct(0x31, String::from("SWAP C /!\\"), String::from("Swap upper and lower nibble of C"), 0, 8, Op::no(InstrucFn::nop));
    //out[0x32] = Instruct::build_instruct(0x32, String::from("SWAP D /!\\"), String::from("Swap upper and lower nibble of D"), 0, 8, Op::no(InstrucFn::nop));
    //out[0x33] = Instruct::build_instruct(0x33, String::from("SWAP E /!\\"), String::from("Swap upper and lower nibble of E"), 0, 8, Op::no(InstrucFn::nop));
    //out[0x34] = Instruct::build_instruct(0x34, String::from("SWAP H /!\\"), String::from("Swap upper and lower nibble of H"), 0, 8, Op::no(InstrucFn::nop));
    ...
    //Rotates
    out[0x07] = Instruct::build_instruct(0x07, String::from("RLCA"), String::from("Rotate A left, old bit 7 to C flag."), 0, 4, Op::no(InstrucFn::rlca));
    ...
    out[0xCB] = Instruct::build_instruct(0xCB, String::from("PREFIX 5/256/!\\"), String::from("My personal favourite <3"), 1, 12, Op::ramu8(InstrucFn::prefix));//TODO TIMING
    ...
    out[0xC2] = Instruct::build_instruct(0xC2, String::from("JP NZ nn"), String::from("Jump to nn if Z=0"), 2, 12, Op::u16(InstrucFn::jp_nz_u16));
    out[0xCA] = Instruct::build_instruct(0xCA, String::from("JP Z nn"), String::from("Jump to nn if Z=1"), 2, 12, Op::u16(InstrucFn::jp_z_u16));
    out[0xD2] = Instruct::build_instruct(0xD2, String::from("JP NC nn"), String::from("Jump to nn if C=0"), 2, 12, Op::u16(InstrucFn::jp_nc_u16));
    out[0xDA] = Instruct::build_instruct(0xDA, String::from("JP C nn"), String::from("Jump to nn if C=1"), 2, 12, Op::u16(InstrucFn::jp_c_u16));
    out[0xE9] = Instruct::build_instruct(0xE9, String::from("JP (HL)"), String::from("Jump to (HL)"), 0, 4, Op::no(InstrucFn::jp_hl));
